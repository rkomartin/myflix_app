...
feature "User interacts with the queue" do
	scenario "user adds and reorders videos in the queue" do
		comedies = Fabricate(:genre)
		monk = Fabricate(:video, title: "Monk", genre: comedies)
		south_park = Fabricate(:video, title: "South Park", genre: comedies)
		futurama = Fabricate(:video, title: "Futurama", genre: comedies)
